...
public class MockEmailDataProvider {
    ...
    private EmailDto buildGmailWelcomeEmail() {
        ...
        return EmailDto.builder()
                ...
                .sender(GOOGLE_TEAM)
                .recipients(List.of("demo.user@example.com"))
                .subject("Welcome to your connected Gmail account, Alex!")
                .snippet("Hi Alex, your Gmail address is now securely connected to AiMail Copilot with OAuth 2.0 PKCE...")
                .timestamp("10:45 AM")
    ...
    private EmailDto buildGoogleSecurityEmail() {
        return EmailDto.builder()
                ...
                .recipients(List.of("demo.user@example.com"))
                .subject("Security alert for demo.user@example.com: AiMail was granted access")
    ...
    private EmailDto buildTeamProjectEmail() {
        ...
        return EmailDto.builder()
                ...
                .snippet("Hey Alex, I've uploaded the deliverables for the hiring task and frontend project. Let me know when you can review...")
                .timestamp("09:30 AM")
        ...
        return EmailDto.builder()
                ...
                .thread(List.of(
                        ThreadMessageDto.builder()
                                ...
                                .body("Hi Sarah,\n\nI have successfully configured the OAuth 2.0 login gateway and verified synchronization with my Gmail account (demo.user@example.com). Everything is working smoothly!\n\nBest regards,\nAlex Kumar")
                                .build()
                ))
                .build();
    }
